...
`.github/workflows/daily-report.yml` 使用 cron `30 23 * * *`，等於台灣時間每天早上 7:30。Workflow 會 checkout repo、安裝依賴、執行 `scripts/generateDailyReport.ts`，並把產生的 JSON commit 回 GitHub。
